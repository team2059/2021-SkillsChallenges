...
public class DrivebaseSubsytem extends SubsystemBase {
  ...
  CANSparkMax leftMid = new CANSparkMax(Constants.leftMiddleMotorPort, CANSparkMaxLowLevel.MotorType.kBrushless);
  ...
  CANSparkMax rightMid = new CANSparkMax(Constants.rightMiddleMotorPort, CANSparkMaxLowLevel.MotorType.kBrushless);
